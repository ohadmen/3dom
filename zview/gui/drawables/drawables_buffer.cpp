...
// void DrawablesBuffer::addandOwn(std::unique_ptr<DrawableBase>& p)
// {
//     m_drawobjs.emplace_back(std::move(p));
//     emit addItem(m_drawobjs.back()->getName().c_str());
// }
// void DrawablesBuffer::add(DrawableBase* p)
// {
// 	m_drawobjs.emplace_back(p);
//     emit addItem(p->getName().c_str());
// }
